...
const Search = () => {
    ...
    return (
        <Dialog open={openModal} onOpenChange={setOpenModal}>
            <DialogTrigger className="flex h-9 w-9 items-center justify-center rounded-full transition-colors hover:bg-accent sm:w-auto sm:min-w-48 sm:justify-start sm:gap-2 sm:rounded-md sm:border sm:border-border sm:px-4 sm:py-1.5 sm:hover:bg-transparent cursor-pointer">
            ...
            <DialogContent className="w-full max-w-2xl p-0 gap-0 [&>button]:hidden">
                ...
                <div className="flex-1 overflow-auto pt-0">
                    <SimpleBar className="max-h-72 px-6 [&_.simplebar-scrollbar::before]:bg-border [&_.simplebar-scrollbar::before]:opacity-100">
